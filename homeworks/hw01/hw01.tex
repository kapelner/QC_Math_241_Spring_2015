...
\begin{enumerate}
\easysubproblem Let $\Omega_E$ denote the sample space of a Euchre deck and $\Omega$ denote the sample space of a full deck. 

\easysubproblem Is $\Omega_E \subset \Omega$ true?
