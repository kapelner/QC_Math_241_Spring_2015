...
\date{Due 5PM outside my office, Tuesday, Feb 17, 2015 \\ \vspace{0.5cm} \small (this document last updated \today ~at \currenttime)}
}
...
Reading is still \textit{required}. For this homework set, read the section about sample spaces in Chapter 2 and permutations / combinations in Chapter 1 in Ross as well as the section about Stirling's approximation. Chapter references are from the 7th edition. You also need to read the first six pages of \href{http://www.amazon.com/Philosophical-Theories-Probability-Issues-Science/dp/041518276X}{Chapter 1 of Donald Gillies ``Philosophical Theories of Probability''}.
...
\hardsubproblem What is the probability we get two pairs of musicians? For example: two guitarists and two bassists. \spc{3}

\hardsubproblem What is the probability we get all four musicians be the same type? \spc{3}
