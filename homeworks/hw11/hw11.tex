...
\hardsubproblem Use the same numbers in the previous problem, but now you only care to test the theory that the proportion of males is greater than 0.5; thus, $H_a: p > 0.5$.  Write the hypotheses, find the acceptance region and find the result and interpret it. \spc{10}
